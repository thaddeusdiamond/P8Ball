 ...
 *
 * @section DESCRIPTION
 * This is the D3D rendering implementation created application with our application
 */
#include "pch.h"
...
D3DRenderer::D3DRenderer(Windows::UI::Core::CoreWindow^ window) : m_window(window)
{
	...
	background_color_[0] = 0.f;
	background_color_[1] = 133.f/255.f;
	background_color_[2] = 167.f/255.0f;
	background_color_[3] = 1.0f;
}
...
void D3DRenderer::Clear()
{
	...
	m_d3dContext->ClearRenderTargetView(m_renderTargetView.Get(), background_color_);
