 ...
 *
 * @section DESCRIPTION
 * This is the standard D3D viewer implementation that comes with a new Windows 8 immersive application
 */
#include "pch.h"
#include "D3DView.h"
...
D3DView::D3DView(CoreWindow^ window, CoreApplicationView^ applicationView) 
    : m_window(window), m_view(applicationView)
{
	...
	m_renderer = ref new P8Ball(window);
